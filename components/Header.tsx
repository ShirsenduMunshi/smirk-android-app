    ...
    <View style={homeStyles.header}>
      <View style={homeStyles.titleContainer}>
        <LinearGradient colors={colors.gradients.primary} style={homeStyles.iconContainer}>
          {/* <Ionicons name='logo-sass' color={'#fff'} size={28} /> */}
          <Image
            source={require("@/assets/images/logo.svg")} // Use your path alias
            style={{ width: 28, height: 28 }}            // Match the size of the previous icon
            contentFit="contain"                        // Ensures the logo doesn't stretch
          />
        </LinearGradient>
